    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
      ...
      <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
        ...
        <ul class="nav-group-items compact">
          ...
          <li class="nav-item"><a class="nav-link" href="icons/coreui-icons-brand.html"><span class="nav-icon"><span
                  class="nav-icon-bullet"></span></span> CoreUI Icons - Brand</a></li>
      ...
      <div class="container-lg px-4">
        <div class="row mb-4">
          ...
          <div class="col-xl-7 col-xxl-8"><a class="banner-coreui-pro"
              ...
              <p>Unlock a world of possibilities: More themes, enhanced components (Date Picker, Multi Select, and
                more), and priority support.</p>
            </a></div>
        </div>
                    ...
                    <tbody>
                      <tr class="align-middle">
                        ...
                        <td>
                          ...
                          <div class="small text-body-secondary text-nowrap"><span>New</span> | Registered: Jan 1, 2023
                          </div>
                        </td>
                        <td class="text-center">
                      ...
                      <tr class="align-middle">
                        ...
                        <td>
                          ...
                          <div class="small text-body-secondary text-nowrap"><span>Recurring</span> | Registered: Jan 1,
                            2023</div>
                        </td>
                        <td class="text-center">
                          <svg class="icon icon-xl">
